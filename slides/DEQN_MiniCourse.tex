...
\vspace{0.1cm}
\begin{center}
\includegraphics[width=0.95\textwidth]{figures/gp_active_learning.pdf}
\end{center}
...
{\small \textbf{Key contrast with uniform:} BAL concentrates points where the function is hardest to approximate.}
\end{frame}
